...
const ar: Dictionary = {
	...
	notifyPhones: {
		...
		subtitle: "أرقام واتساب التي تستقبل تنبيهات تحويل المحادثات من البوت.",
		listTitle: "الأرقام المسجلة",
		empty: "لا يوجد رقم إشعارات بعد.",
		emptyHint: "أضف رقماً لبدء استقبال تنبيهات التحويل.",
		addTitle: "إضافة رقم",
		addSubtitle: "يجب أن يكون الرقم قادراً على استقبال رسائل واتساب.",
		phone: "رقم الهاتف",
		label: "الوصف",
		labelPlaceholder: "الوردية الليلية، المشرف…",
		add: "إضافة الرقم",
		adding: "جارٍ الإضافة…",
		...
		deleteBody: "لن يستقبل {phone} تنبيهات التحويل بعد الآن."
	},
	logs: {
		title: "السجلات",
