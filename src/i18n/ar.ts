...
const ar: Dictionary = {
	...
	chat: {
		...
		leadAdded: "تمت إضافة العميل المحتمل.",
		leadAlreadyOpen: "توجد بالفعل حالة مفتوحة لهذه الخدمة على هذه المحادثة.",
		tabMessages: "الرسائل",
		tabActivity: "السجل"
	},
	...
	leads: {
		...
		subtitle: "عملاء يريدون خدمة معينة ويحتاجون متابعة من فريقنا.",
		listTitle: "العملاء المحتملون",
		empty: "لا توجد حالة مطابقة لهذا الفلتر.",
		addTitle: "إضافة عميل محتمل",
		addSubtitle: "اربط الحالة بمحادثة وخدمة محددة.",
		...
		add: "إضافة",
		adding: "جارٍ الإضافة…",
		added: "تمت إضافة العميل المحتمل.",
		duplicate: "توجد بالفعل حالة مفتوحة لهذه الخدمة على هذه المحادثة.",
		searchPlaceholder: "ابحث بالهاتف أو الاسم…",
		filters: { open: "مفتوحة", closed: "مغلقة", all: "الكل" },
		source: { all: "كل المصادر", ai: "الذكاء الاصطناعي", agent: "موظف" },
		sourceLabel: { ai: "بوت الذكاء الاصطناعي", agent: "موظف" },
		mineOnly: "حالاتي فقط",
		...
		close: "إغلاق",
		closeTitle: "إغلاق هذه الحالة",
		closeSubtitle: "أضف وصفاً موجزاً لسبب إغلاق هذه الحالة.",
		closeNote: "الوصف",
		closeNotePlaceholder: "قام العميل بالحجز والدفع…",
		confirmClose: "إغلاق الحالة",
		closing: "جارٍ الإغلاق…",
		closed: "تم إغلاق الحالة.",
		reopen: "إعادة فتح",
		reopening: "جارٍ إعادة الفتح…",
		reopened: "تمت إعادة فتح الحالة.",
