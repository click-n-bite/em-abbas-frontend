const en = {
	...
	notifyPhones: {
		...
		subtitle: "WhatsApp numbers that receive handoff alerts from the bot.",
		listTitle: "Registered numbers",
		empty: "No notification number yet.",
		emptyHint: "Add a number to start receiving handoff alerts.",
		addTitle: "Add a number",
		addSubtitle: "The number must be able to receive WhatsApp messages.",
		phone: "Phone number",
		label: "Label",
		labelPlaceholder: "Night shift, supervisor…",
		add: "Add number",
		adding: "Adding…",
		added: "Number added.",
		...
		deleteBody: "{phone} will stop receiving handoff alerts."
	},
	logs: {
		title: "Logs",
